...
# Base Secret Key
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-+oktu%#3u27xy+%u*&o4xdf#hb5*o5b0k+lpo=kx*ny#jqb9sf')
...
IS_TESTING = 'pytest' in sys.modules or any('pytest' in arg for arg in sys.argv) or 'test' in sys.argv
